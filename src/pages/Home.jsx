    ...
    <div>
      ...
      <div className="min-h-screen bg-gray-100 flex flex-col items-center text-gray-900 font-semibold font-poppins">
        ...
        <div className="w-full bg-blue-500 text-white text-center py-20">
          <h1 className="text-4xl ">Selamat Datang di Klinik drg. Irna</h1>
          <p className="mt-2 text-lg">
            Perawatan terbaik untuk kesehatan gigi dan mulut Anda
          </p>
          <button className="mt-4 bg-white text-blue-500 px-6 py-2 rounded-full shadow-md hover:bg-gray-200 transition">
            Buat Janji Sekarang
          </button>
        </div>
        ...
        <div className="w-4/5 my-10 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 bg-white rounded-xl shadow-lg text-center">
            ...
            <h2 className=" text-xl">Pemeriksaan Gigi</h2>
          ...
          <div className="p-6 bg-white rounded-xl shadow-lg text-center">
            <div className="text-blue-500 text-3xl mb-2">✨</div>
            <h2 className=" text-xl">Pembersihan Karang Gigi</h2>
            <p className="text-gray-600 mt-2">
          ...
          <div className="p-6 bg-white rounded-xl shadow-lg text-center">
            <div className="text-blue-500 text-3xl mb-2">💉</div>
            <h2 className=" text-xl">Penambalan & Pencabutan</h2>
            <p className="text-gray-600 mt-2">
